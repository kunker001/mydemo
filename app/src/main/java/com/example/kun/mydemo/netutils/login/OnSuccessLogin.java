...
public class OnSuccessLogin extends DisposableObserver<TokenBean>
    implements ProgressCancelListener {
    /**
     * 是否需要显示默认Loading
     */
    private boolean showProgress = true;
    private OnSuccessLoginListener mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessLogin(OnSuccessLoginListener mOnSuccessAndFaultListener) {
     ...
     * @param context 上下文
     */
    public OnSuccessLogin(OnSuccessLoginListener mOnSuccessAndFaultListener, Context context) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessLogin(OnSuccessLoginListener mOnSuccessAndFaultListener, Context context, boolean showProgress) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
        this.context = context;
        progressDialog = new ProgressDialog(context);
     ...
     */
    @Override
    public void onNext(TokenBean body) {
        try {
