...
public class OnSuccessUinfo extends DisposableObserver<UserInfo>
    implements ProgressCancelListener {
    /**
     * 是否需要显示默认Loading
     */
    private boolean showProgress = true;
    private OnSuccessUinfoListener mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessUinfo(OnSuccessUinfoListener mOnSuccessAndFaultListener) {
     ...
     * @param context 上下文
     */
    public OnSuccessUinfo(OnSuccessUinfoListener mOnSuccessAndFaultListener, Context context) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessUinfo(OnSuccessUinfoListener mOnSuccessAndFaultListener, Context context, boolean showProgress) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
        this.context = context;
        progressDialog = new ProgressDialog(context);
     ...
     */
    @Override
    public void onNext(UserInfo body) {
        try {
