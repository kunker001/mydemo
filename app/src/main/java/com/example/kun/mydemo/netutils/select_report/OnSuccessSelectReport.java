...
public class OnSuccessRepairMan extends DisposableObserver<RepairManInfo>
    implements ProgressCancelListener {
    /**
     * 是否需要显示默认Loading
     */
    private boolean showProgress = true;
    private OnSuccessRepairManListener mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessRepairMan(OnSuccessRepairManListener mOnSuccessAndFaultListener) {
     ...
     * @param context 上下文
     */
    public OnSuccessRepairMan(OnSuccessRepairManListener mOnSuccessAndFaultListener, Context context) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessRepairMan(OnSuccessRepairManListener mOnSuccessAndFaultListener, Context context, boolean showProgress) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
        this.context = context;
        progressDialog = new ProgressDialog(context);
     ...
     */
    @Override
    public void onNext(RepairManInfo body) {
        try {
