package com.example.kun.mydemo.netutils.image;
...
import com.example.kun.mydemo.netutils.ProgressCancelListener;
...
public class OnSuccessImageResult extends DisposableObserver<ImageResultBean>
    implements ProgressCancelListener {
    /**
     * 是否需要显示默认Loading
     */
    private boolean showProgress = true;
    private OnSuccessImageResultListener mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessImageResult(OnSuccessImageResultListener mOnSuccessAndFaultListener) {
     ...
     * @param context 上下文
     */
    public OnSuccessImageResult(OnSuccessImageResultListener mOnSuccessAndFaultListener, Context context) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessImageResult(OnSuccessImageResultListener mOnSuccessAndFaultListener, Context context, boolean showProgress) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
        this.context = context;
        progressDialog = new ProgressDialog(context);
     ...
     */
    @Override
    public void onNext(ImageResultBean body) {
        try {
