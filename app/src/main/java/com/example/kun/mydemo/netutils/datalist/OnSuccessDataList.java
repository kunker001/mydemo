...
public class OnSuccessDataList extends DisposableObserver<ResultContent>
    implements ProgressCancelListener {
    /**
     * 是否需要显示默认Loading
     */
    private boolean showProgress = true;
    private OnSuccessDataListListener mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessDataList(OnSuccessDataListListener mOnSuccessAndFaultListener) {
     ...
     * @param context 上下文
     */
    public OnSuccessDataList(OnSuccessDataListListener mOnSuccessAndFaultListener, Context context) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
     ...
     */
    public OnSuccessDataList(OnSuccessDataListListener mOnSuccessAndFaultListener, Context context, boolean showProgress) {
        this.mOnSuccessAndFaultListener = mOnSuccessAndFaultListener;
        this.context = context;
        progressDialog = new ProgressDialog(context);
     ...
     */
    @Override
    public void onNext(ResultContent body) {
        try {
